...
const ReplyItem:FC<IProps>=(props)=>{
  const { reply,id,user,replyIndex,index,propsShowReplyHandle,propsReplyReplyHandle } = props;
  ...
  return (
      <ReplyItemWrapper>
        ...
        <div className="right-msg">
          ...
          {
            (id && typeof reply.reply ==="object"  &&reply.reply.hasOwnProperty("user") && reply.reply.id !== id) && <div className="reply-for-name">
              @{reply.reply? (typeof reply.reply ==="object"  &&reply.reply.hasOwnProperty("user") ? reply.reply.user.userName :"") :''}
            </div>
          }
