"use strict";
(self["webpackChunkcodergb_hub_client"] = self["webpackChunkcodergb_hub_client"] || []).push([[6431],{
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ subscriptions; }
});
...
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.browser.esm.js + 9 modules
var styled_components_browser_esm = __webpack_require__(53133);
;// CONCATENATED MODULE: ./src/views/subscriptions/style.tsx

const SubscriptionsWrapper = styled_components_browser_esm/* default */.ZP.div`
  .header-title {
    display: flex;
    justify-content: space-between;
    .manage {
...
;// CONCATENATED MODULE: ./src/views/subscriptions/childCpn/more/style.tsx

const MoreVideoWrapper = styled_components_browser_esm/* default */.ZP.div`
  .more-title {
    display: flex;
    justify-content: space-between;
    font-size: ${24 / 40}rem;
...
`;
;// CONCATENATED MODULE: ./src/views/subscriptions/childCpn/more/index.tsx
...
const MoreVideo = () => {
  const navigate = (0,dist/* useNavigate */.s0)();
  const [weekVideo, setWeekVideo] = (0,react.useState)([]);
  ...
  (0,react.useEffect)(() => {
    (0,video/* getSubUserVideo */.Mo)(login.userMsg.userId, 0, 10, 0).then(data => {
      if (data.status === 200) {
  ...
  const mouseImgHandle = async (item, index) => {
    ...
    const res = await (0,video/* getVideoURL */.fY)(item.id);
    if (res.status === 200) {
  ...
  return /*#__PURE__*/react.createElement(MoreVideoWrapper, null, /*#__PURE__*/react.createElement("div", {
    className: "more-title"
  }, "\u66F4\u65E9"), /*#__PURE__*/react.createElement("ul", {
    className: "sub-user-vio-list"
...
/* harmony default export */ var more = (/*#__PURE__*/(0,react.memo)(MoreVideo));
;// CONCATENATED MODULE: ./src/views/subscriptions/index.tsx
...
const Subscriptions = () => {
  ...
  (0,react.useEffect)(() => {
    (0,video/* getSubUserVideo */.Mo)(login.userMsg.userId, 0, 10, 1).then(data => {
      if (data.status === 200) {
        setWeekVideo(data.data.list);
      }
    });
  ...
  return /*#__PURE__*/react.createElement(SubscriptionsWrapper, null, /*#__PURE__*/react.createElement("div", {
    className: "header-title"
  }, /*#__PURE__*/react.createElement("div", {
    className: "current-time"
  }, "\u672C\u6708"), /*#__PURE__*/react.createElement("div", {
    className: "manage",
    onClick: e => manageRouteHandle()
  }, "\u7BA1\u7406")), /*#__PURE__*/react.createElement("ul", {
    className: "sub-user-vio-list"
  }, weekVideo && weekVideo.length !== 0 && weekVideo.map((item, index) => {
    return /*#__PURE__*/react.createElement("li", {
      key: item.id,
  ...
  }), (0,holder/* default */.Z)(weekVideo.length, 5, 300)), /*#__PURE__*/react.createElement(more, null));
};
/* harmony default export */ var subscriptions = (/*#__PURE__*/(0,react.memo)(Subscriptions));
...
//# sourceMappingURL=5a492cfddfee6625f1af.bundle.js.map