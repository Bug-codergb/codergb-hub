"use strict";
(self["webpackChunkcodergb_hub_client"] = self["webpackChunkcodergb_hub_client"] || []).push([[3474],{
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ library; }
});
...
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.browser.esm.js + 9 modules
var styled_components_browser_esm = __webpack_require__(53133);
;// CONCATENATED MODULE: ./src/views/library/style.tsx

const LibraryWrapper = styled_components_browser_esm/* default */.ZP.div`
  display: flex;
  align-items: flex-start;
  .left-content {
    width: 75%;
...
// EXTERNAL MODULE: ./node_modules/react-router/dist/index.js
var dist = __webpack_require__(89250);
;// CONCATENATED MODULE: ./src/views/library/childCpn/videoList/style.tsx
...
`;
;// CONCATENATED MODULE: ./src/views/library/childCpn/headerTitle/style.tsx

const HeaderTitleWrapper = styled_components_browser_esm/* default */.ZP.div`
  .header-title {
    display: flex;
    align-items: center;
    justify-content: space-between;
...
`;
;// CONCATENATED MODULE: ./src/views/library/childCpn/headerTitle/index.tsx
...
const HeaderTitle = props => {
  ...
  return /*#__PURE__*/react.createElement(HeaderTitleWrapper, null, /*#__PURE__*/react.createElement("div", {
...
/* harmony default export */ var headerTitle = (/*#__PURE__*/(0,react.memo)(HeaderTitle));
...
;// CONCATENATED MODULE: ./src/views/library/childCpn/videoList/index.tsx
...
const VideoList = props => {
  ...
  return /*#__PURE__*/react.createElement(VideoListWrapper, null, /*#__PURE__*/react.createElement(headerTitle, {
    title: title,
    more: more,
    moreHandle: () => {
      moreClickHandle();
...
const Library = () => {
  ...
  const [later, setLater] = (0,react.useState)([]);
  const login = (0,es/* useSelector */.v9)(state => {
    return state.getIn(['loginReducer', 'login']);
  });
  (0,react.useEffect)(() => {
    (0,network_history/* getUserHistory */.p5)(login.userMsg.userId, 0, 4, '').then(data => {
      if (data.status === 200) {
  ...
  (0,react.useEffect)(() => {
    (0,network_later/* getUserLater */.d)(login.userMsg.userId, 0, 4).then(data => {
      if (data.status === 200) {
  ...
  const [userlib, setUserlib] = (0,react.useState)({
    subCount: 0,
    uploadCount: 0,
    thumbCount: 0
  });
  (0,react.useEffect)(() => {
    (0,user/* getUserLibrary */.ur)(login.userMsg.userId).then(res => {
      if (res.status === 200) {
        setUserlib(res.data);
      }
    });
  ...
  const moreHandle = () => {};
  return /*#__PURE__*/react.createElement(LibraryWrapper, null, /*#__PURE__*/react.createElement("div", {
    ...
    className: "avatar-outer"
  }, /*#__PURE__*/react.createElement("img", {
    src: login.userMsg.avatarUrl,
    alt: login.userMsg.userName
  })), /*#__PURE__*/react.createElement("div", {
    className: "user-name"
  }, login.userMsg.userName), /*#__PURE__*/react.createElement("ul", {
    className: "sub-upload-thumb"
  }, /*#__PURE__*/react.createElement("li", null, /*#__PURE__*/react.createElement("span", null, "\u8BA2\u9605\u6570\u91CF"), /*#__PURE__*/react.createElement("span", null, userlib.subCount)), /*#__PURE__*/react.createElement("li", null, /*#__PURE__*/react.createElement("span", null, "\u4E0A\u4F20\u6570\u91CF"), /*#__PURE__*/react.createElement("span", null, userlib.uploadCount)), /*#__PURE__*/react.createElement("li", null, /*#__PURE__*/react.createElement("span", null, "\u9876\u8FC7\u7684\u89C6\u9891\u6570"), /*#__PURE__*/react.createElement("span", null, userlib.thumbCount)))));
};
/* harmony default export */ var library = (/*#__PURE__*/(0,react.memo)(Library));
...
//# sourceMappingURL=0d5e68799c82a6c314b4.bundle.js.map