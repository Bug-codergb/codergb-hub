"use strict";
(self["webpackChunkcodergb_hub_client"] = self["webpackChunkcodergb_hub_client"] || []).push([[3935],{
...
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.browser.esm.js + 9 modules
var styled_components_browser_esm = __webpack_require__(53133);
;// CONCATENATED MODULE: ./src/views/recommend/style.tsx

const RecommendWrapper = styled_components_browser_esm/* default */.ZP.div`
  position: relative;
  .video-list {
    height: 87vh;
    display: flex;
    ...
    & > li {
      ...
      overflow: hidden;
      &.active {
        transform: ${props => props.isRightBoundray ? props.isTopBoundray ? 'scale(1.3) translate(-14%,12%)' : 'scale(1.3) translate(-14%,8%)' : props.isLeftBoundray ? props.isTopBoundray ? 'scale(1.3) translate(14%,12%)' : 'scale(1.3) translate(14%,8%)' : props.isTopBoundray ? 'scale(1.3) translate(0,12%)' : 'scale(1.3) translate(0,8%)'};
...
;// CONCATENATED MODULE: ./src/views/recommend/index.tsx
...
const Recommend = () => {
  ...
  const [isRight, setIsRight] = (0,react.useState)(false);
  const [isLeft, setIsLeft] = (0,react.useState)(false);
  const [isTop, setIsTop] = (0,react.useState)(false);
  const navigate = (0,dist/* useNavigate */.s0)();
  const vioRef = (0,react.useRef)(null);
  const vioListRef = (0,react.useRef)(null);
  (0,react.useEffect)(() => {
    (0,network_video/* getAllVideo */.N$)(0, 50, '').then(data => {
      if (data.status === 200) {
        if (data.data.list && data.data.list.length !== 0) {
          for (const item of data.data.list) {
            item.vioRef = /*#__PURE__*/(0,react.createRef)();
          }
  ...
  const isBoundary = (containerWidth, itemWidth, itemOffset, boundary) => {
  ...
  return /*#__PURE__*/react.createElement(RecommendWrapper, {
    isLeftBoundray: isLeft,
    isRightBoundray: isRight,
    isTopBoundray: isTop
...
/* harmony default export */ var recommend = (/*#__PURE__*/(0,react.memo)(Recommend));
...
//# sourceMappingURL=5b675c7033e23daa415f.bundle.js.map