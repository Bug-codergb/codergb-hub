"use strict";
(self["webpackChunkcodergb_hub_client"] = self["webpackChunkcodergb_hub_client"] || []).push([[3580],{
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ searchDetail; }
});
...
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.browser.esm.js + 9 modules
var styled_components_browser_esm = __webpack_require__(53133);
;// CONCATENATED MODULE: ./src/components/content/detail/searchDetail/style.tsx

const SearchDetailWrapper = styled_components_browser_esm/* default */.ZP.div`
  height: 80vh;
  overflow-y: scroll;
  .search-list {
    & > li {
...
;// CONCATENATED MODULE: ./src/components/content/detail/searchDetail/index.tsx
...
const SearchDetail = () => {
  ...
  const getAllVideoReq = (offset, limit, keyword) => {
    (0,network_video/* getAllVideo */.N$)(offset, limit, keyword).then(data => {
      if (data.status === 200) {
  ...
  return /*#__PURE__*/react.createElement(SearchDetailWrapper, null, /*#__PURE__*/react.createElement("ul", {
...
/* harmony default export */ var searchDetail = (/*#__PURE__*/(0,react.memo)(SearchDetail));
...
//# sourceMappingURL=442ebebdcff384763a4e.bundle.js.map